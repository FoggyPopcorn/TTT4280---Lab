...
#define MOSI 12    // GPIO for SPI MOSI (GPIO 10 aka SPI_MOSI). MOSI not in use here due to single ch. ADCs, but must be defined anyway.
#define SPI_SS 15   // GPIO for slave select (GPIO 15).
#define CLK 7     // GPIO for SPI clock (GPIO 16).
